...
import 'package:homely_user/Helper/service_error_widget.dart';
...
import 'package:homely_user/Screen/Search.dart';
...
showServiceScreen( BuildContext context1,ValueChanged onChange) {

  OverlayEntry? overlayEntry;
  ValueChanged onResult = (result){
      if(result!=null&&overlayEntry!=null){
        onChange(true);
        overlayEntry.remove();
      }
  };
  overlayEntry = OverlayEntry(
    builder: (context) => Positioned(
      left: 0,
      right: 0,
      child: ServiceErrorWidget(onResult),
    ),
  );
