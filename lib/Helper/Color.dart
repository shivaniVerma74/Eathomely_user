...
extension colors on ColorScheme {
  ...
  static const Color primary = Color(0xff814030);
  static const Color secondary = Color(0xff814030);
  ...
  static const Color grad1Color = Color(0xff814030);
  static Color grad2Color = Color(0xff814030);
