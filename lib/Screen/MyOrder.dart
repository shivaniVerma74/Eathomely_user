...
class StateMyOrder extends State<MyOrder> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: widget.isFromBottom == true
          ? null
      ...
      return Card(
        ...
        child: InkWell(
          ...
          child: Column(children: <Widget>[
                      ...
                      child: Column(
                          ...
                          children: <Widget>[
                            ...
                            Padding(
                              ...
                              child: Text(searchList[index].product_order_type??"",style: TextStyle(color: Colors.green),),
                            )
                          ]))),
              const Spacer(),
              Padding(
            ...
            searchList[index].product_order_type == "subscription_order" && orderItem.startdate!= null ? Row(
              children: List.generate(int.parse(orderItem.totaldelivery ?? "1"), (index){
                  DateTime date = DateTime.parse(orderItem.startdate!).add(Duration(days: index));
                  return Container(
