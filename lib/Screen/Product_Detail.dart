...
import 'package:homely_user/Screen/ReviewList.dart';
                              ...
                              if (model.addOnList![i].price == '' ||
                                ...
                                return Padding(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ChoiceChip(
                                        selected: addIdList.indexWhere((element) => element.id == model.addOnList![i].id!) != -1
                                            ? true
                                            : false,
                                        label: Row(
                                          children: [
                                            Icon(
                                              addIdList.indexWhere((element) => element.id == model.addOnList![i].id!) != -1
                                                  ? Icons.check_box
                                            ...
                                            Text(
                                                model.addOnList![i].name.toString(), style: TextStyle(
